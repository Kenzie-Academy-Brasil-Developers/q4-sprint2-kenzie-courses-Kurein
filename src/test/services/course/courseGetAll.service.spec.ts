...
describe("Creating a Course", () => {
  ...
  test("Service function Create Course should create an admin user, get its id, create a course and return its values", async () => {
    ...
    const courseModel = { courseName, duration, id: courseId, students: [] };
